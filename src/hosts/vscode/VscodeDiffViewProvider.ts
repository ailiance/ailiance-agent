...
export class VscodeDiffViewProvider extends DiffViewProvider {
	 ...
	 * `atomicWriteFile` from `@utils/fs`). Rationale (v0.6 Fix-A, Sprint 3):
	 *
	 ...
	 *
	 * Atomicity guarantee for Fix-A is therefore: covered on the CLI path,
	 * delegated to VS Code's save pipeline on the editor path.
	 */
