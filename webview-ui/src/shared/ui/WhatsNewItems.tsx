import type { BannerAction, BannerCardData } from "@shared/isaac/banner"
	...
	return (
		<ul className="text-sm pl-3 list-disc" style={{ color: "var(--vscode-descriptionForeground)" }}>
			{hasWelcomeBanners ? (
				...
				<>
					<li className="mb-2">
						<strong>Hash Anchored MultiFile Edits:</strong> Isaac targets line hashes to perform high accuracy code
						edits and can batch multiple edits in a single file and multiple files in one shot.
					</li>
					<li className="mb-2">
						<strong>AST Precision:</strong> Isaac understands language syntax and can read from and manipulate a
						language's syntax directly (such as extract a function or replace a function)
					</li>
					<li className="mb-2">
						<strong>Minimal Roundtrips:</strong> Isaac can process multiple files or run multiple safe commands in
						parallel, minimizing roundtrip and API costs.
					</li>
					<li className="mb-2">
						<strong>Speed and Performance:</strong> Countless context curation optimizations allow Isaac to run lean
