...
echo ""
echo "Download the platform tarball from the release (no authentication required):"
echo "  curl -L -o isaac.tar.gz https://github.com/ailiance/isaac-cli/releases/download/<tag>/isaac-<platform>.tar.gz"
echo "  # then extract and add bin/isaac to your PATH"
